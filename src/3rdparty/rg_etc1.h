...
struct rg_etc1_etc1_pack_params
{
  enum rg_etc1_etc1_quality m_quality;
  int m_dithering;
};
...
unsigned int rg_etc1_pack_etc1_block(void* pETC1_block, const unsigned int* pSrc_pixels_rgba, struct rg_etc1_etc1_pack_params* pack_params);
